...
class Settings(BaseSettings):
    ...
    MONGO_DB_NAME: str = "futbolagents"
    MONGO_STATE_CHECKPOINT_COLLECTION: str = "player_state_checkpoints"
    MONGO_STATE_WRITES_COLLECTION: str = "player_state_writes"
    MONGO_LONG_TERM_MEMORY_COLLECTION: str = "player_long_term_memory"
